        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-inner text-center breadcrumb-inner-bg">
                    <h1 class="text-white">Full Body Harness | MAFT, UAE</h1>
                </div>
                <div class="meta text-end">
                    <a href="{{ route('index') }}" class="prev">Home/</a>
                    <a href="{{ route('products') }}" class="prev">products/</a>
                    <a href="{{ route('product17') }}" class="next">Full Body Harness</a>
                </div>
        ...
        <div class="rts-project-details-thumbnail">
            <div class="container">
                <div class="row g-24">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/fbh3.webp') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/fbh4.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                </div>
            </div>
