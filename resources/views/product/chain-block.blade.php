        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="meta text-end">
                    ...
                    <a href="{{ route('product9') }}" class="next">Chain block</a>
                </div>
...
<div class="rts-project-details-area pb--100 pt--25">
    <div class="container">
        <div class="row mt--70 mb--50">
            <div class="col-12">
                <div class="product-details-main-inner" data-sal="slide-up" data-sal-delay="150" data-sal-duration="900">
                    ...
                    <h3 class="title animated fadeIn">Heavy-Duty Chain Blocks for Safe Lifting – MAFT UAE</h3>
                    <p class="disc">Manarat Al Falah Trading LLC (MAFT) offers a wide range of manual Chain Blocks (also known as chain hoists) designed for lifting heavy loads safely and efficiently. Trusted by industries across the UAE, our chain blocks are ideal for use in construction, warehouses, workshops, factories, and marine applications.</p>
                    <p class="italic">
                        Built to international safety standards, our chain blocks provide reliable performance, long service life, and smooth operation under demanding conditions.
                    </p>
                </div>
            </div>
        </div>
        <div class="row g-5">
            <div class="col-12">
                <h3 class="title mb--0 animated fadeIn" data-sal="slide-up" data-sal-delay="150" data-sal-duration="900">Chain Blocks</h3>
                <p>Chain Block, also known as a manual chain hoist, is a mechanical lifting device used to raise and lower heavy loads by pulling on a hand chain. It uses a system of gears and pulleys to multiply force, allowing a single operator to lift heavy weights with minimal effort.</p>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                <h4>Chain Blocks Features</h4>
                <div class="single-project-details-challenge">
                    <div class="icon">
                        <i class="far fa-check-circle"></i>
                    </div>
                    <p class="details">
                        Lifting Capacities from 0.5 Ton to 50 Tons
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                ...
                <div class="single-project-details-challenge">
                    ...
                    <p class="details">
                        Durable Gear Mechanism for smooth operation
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Galvanized or Zinc-Plated Finish for corrosion resistance
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                ...
                <div class="single-project-details-challenge">
                    ...
                    <p class="details">
                        Hooks with Safety Latches for secure attachment
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Complies with EN, ASME, and CE standards
                    </p>
                </div>
            </div>

            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                <h4>Chain Blocks Applications</h4>
                <div class="single-project-details-challenge">
                    <div class="icon">
                        <i class="far fa-check-circle"></i>
                    </div>
