        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="meta text-end">
                    ...
                    <a href="{{ route('product6') }}" class="next">Round Sling</a>
                </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                ...
                <div class="single-project-details-challenge">
                    ...
                    <p class="details">
                        <strong>High-Strength Polyester Material:</strong> Ensures long-lasting durability and load-bearing capacity.
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        <strong>Soft & Flexible Design:</strong> Prevents damage to sensitive surfaces or polished equipment.
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        <strong>Color-Coded for Capacity:</strong> Easy identification of load limits for safe usage.
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        <strong>Lightweight & Easy to Handle:</strong> Simplifies operations and reduces worker fatigue.
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        <strong>Conforms to Safety Standards:</strong> Manufactured according to international lifting safety norms.
                    </p>
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                ...
                <div class="single-project-details-challenge">
                    ...
                    <p class="details">
                        <strong>Construction & Engineering:</strong> Safe lifting of machinery and equipment.
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        <strong>Warehousing & Logistics:</strong> Warehousing & Logistics:
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        <strong>Marine & Oil Industry:</strong> Corrosion-resistant and reliable under tough conditions.
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        <strong>Maintenance & Workshops:</strong> Ideal for lifting components without surface scratches.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row g-24">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/round-sling1.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/round-sling2.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/round-sling3.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/round-sling4.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                </div>
            </div>
