        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-inner text-center breadcrumb-inner-bg">
                    <h1 class="text-white">Snatch Block & Tirfor Winch | MAFT, UAE</h1>
                </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                ...
                <div class="single-project-details-challenge">
                    ...
                    <p class="details">
                        Available in various tonnage capacities (1T to 30T)
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Swivel hook or shackle options
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Side plate opening for easy wire rope fitting
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Smooth sheave operation with heavy load bearing
                    </p>
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                ...
                <div class="single-project-details-challenge">
                    ...
                    <p class="details">
                        Winching and lifting in tight spaces
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Ideal for rigging, recovery, and crane operations
                    </p>
                </div>
            </div>
        </div>
        <div class="row g-5 mt-5">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                ...
                <div class="single-project-details-challenge">
                    ...
                    <p class="details">
                        Unlimited wire rope length (based on application)
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Safe and reliable self-gripping jaws
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                <h4>Tirfor Winch Applications</h4>
                <div class="single-project-details-challenge">
                    <div class="icon">
                        <i class="far fa-check-circle"></i>
                    </div>
                ...
                <div class="single-project-details-challenge">
                    ...
                    <p class="details">
                        Industrial maintenance, scaffolding, and erection work
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row g-24">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/snatch1.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/snatch2.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/snatch3.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/snatch4.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                </div>
            </div>
