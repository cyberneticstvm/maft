        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-inner text-center breadcrumb-inner-bg">
                    <h1 class="text-white">Full Body Harness & Double Webbing Lanyard | MAFT, UAE</h1>
                </div>
                <div class="meta text-end">
                    <a href="{{ route('index') }}" class="prev">Home/</a>
                    <a href="{{ route('products') }}" class="prev">products/</a>
                    <a href="{{ route('product16') }}" class="next">Full Body Harness & Double Webbing Lanyard</a>
                </div>
    ...
    <div class="container">
        <div class="row mt--70 mb--50">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                <h4>Full Body Harness Features</h4>
                <div class="single-project-details-challenge">
                    <div class="icon">
                        <i class="far fa-check-circle"></i>
                    </div>
                    <p class="details">
                        Durable, abrasion-resistant polyester webbing
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Adjustable straps for a custom, secure fit
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Multiple D-rings for fall arrest, work positioning, and rescue
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Comfortable padding on shoulders and back
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Compliance with UAE and international standards (ANSI, OSHA, EN)
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Ideal for construction, oil & gas, manufacturing, and maintenance work
                    </p>
                </div>
            </div>

            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                <h4>Full Body Harness Applications</h4>
                <div class="single-project-details-challenge">
                    <div class="icon">
                        <i class="far fa-check-circle"></i>
                    </div>
                    <p class="details">
                        Construction: Working on scaffolding, roofs, and elevated platforms
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Oil & Gas: Offshore rigs, refineries, and pipeline maintenance
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Manufacturing & Maintenance: Accessing machinery, elevated tanks, and confined spaces
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Telecommunications: Climbing towers and poles
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Utilities & Energy: Electrical line work and wind turbine maintenance
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Warehousing & Logistics: Fall protection in loading docks and mezzanine areas
                    </p>
                </div>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-12">
                <div class="product-details-main-inner" data-sal="slide-up" data-sal-delay="150" data-sal-duration="900">
                    ...
                    <p class="italic">
                        Our double webbing lanyards are tested to meet rigorous safety requirements, providing peace of mind for workers and employers alike.
                    </p>
                </div>
            </div>
        </div>
        <div class="row g-5">
            <div class="col-12">
                <h3 class="title mb--0 animated fadeIn" data-sal="slide-up" data-sal-delay="150" data-sal-duration="900">Double webbing lanyard</h3>
                <p>Double Webbing Lanyard is a fall protection device made from two parallel strips (legs) of high-strength polyester webbing. It connects a worker’s safety harness to secure anchor points, allowing continuous attachment when moving around elevated work areas.</p>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                <h4>Double webbing lanyard Features</h4>
                <div class="single-project-details-challenge">
                    <div class="icon">
                        <i class="far fa-check-circle"></i>
                    </div>
                    <p class="details">
                        Made from premium polyester webbing for durability and flexibility
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Dual-leg design for continuous fall protection
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Heavy-duty snap hooks and connectors for secure anchorage
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Shock-absorbing capability to reduce impact forces
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Compliant with UAE and international safety standards (ANSI, OSHA, EN)
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Ideal for construction, maintenance, oil & gas, and industrial sectors
                    </p>
                </div>
            </div>

            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
                <h4>Double webbing lanyard Applications</h4>
                <div class="single-project-details-challenge">
                    <div class="icon">
                        <i class="far fa-check-circle"></i>
                    </div>
                    <p class="details">
                        Construction sites: Safe movement on scaffolding, roofs, and elevated platforms
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Maintenance and inspection: Accessing confined or elevated spaces
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Oil & gas industry: Working on rigs, pipelines, and offshore platforms
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Industrial manufacturing: Operations requiring fall arrest and positioning
                    </p>
                </div>
                <div class="single-project-details-challenge">
                    <div class="icon">
                    ...
                    <p class="details">
                        Telecommunications & utilities: Climbing towers, poles, and other structures
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row g-24">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/dwl1.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/dwl2.jpeg') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/fbh1.jpeg') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('/assets/images/products/product/fbh2.png') }}" alt="{{ $title }} | Manarat Al Falah Trading LLC">
                        </a>
                    </div>
                </div>
            </div>
